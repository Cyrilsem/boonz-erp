-- PRD-075 rollback body: v_live_shelf_stock with STRICT repurposed_at IS NULL eligibility
-- (pre-PRD-075). Normally rollback = UPDATE pick_urgency_params SET repurpose_grace_days=0.
