-- PRD-087 PERF: get_machine_health (~5s) and get_stock_overview (~0.3s)
-- were each evaluated TWICE inside get_dashboard_summary. Materialize each
-- once. No output shape change vs v3.
