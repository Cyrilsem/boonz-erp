-- PRD-075 follow-up (CS ruling 2026-07-05): logged inventory reconciliations (adjust_pod_inventory,
-- reference_id 'adjust-%') are physical machine visits and must reset the canonical visit clock,
-- same as 'manual-refill-%' events. One condition changed in manual_refill_visit CTE; nothing else.
-- Dry-run proof in chat: flips VOXMCC-1005 22d->2d, ACTIVATEMCC-1037/IFLYMCC-1024/MPMCC-1054 22d->3d,
-- VOXMCC-1011/ACTIVATE-2005 8d->3d; MPMCC-1058 unchanged (no logged refill exists).
