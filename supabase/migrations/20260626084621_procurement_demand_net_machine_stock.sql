-- get_procurement_demand: net machine stock into the demand calc.
-- GENERATED FROM LIVE PROD for git parity (PRD-ALL overnight run, 2026-06-30).
-- Already applied as supabase_migrations version 20260626084621. Idempotent (CREATE OR REPLACE). Do not re-run.
