-- ============================================================================
-- RC-06 ROLLBACK (2026-07-18): restore engine_swap_pod to the exact live body
-- captured from prod on 2026-07-18 BEFORE the RC-06 fix
-- (pg_get_functiondef md5 ce685e14b6164257fb52301cdf5c8e7a).
-- Restores the stale filters:
--   reasoning->>'tagged_by' IN ('engine_add_pod_v15','engine_add_pod_v16')
-- in the opening DELETE and the dead-resolution loop.
-- ============================================================================
