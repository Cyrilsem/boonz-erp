-- ROLLBACK: restore live pre-Batch-2 body of record_actual_refill
-- captured 2026-07-18 from eizcexopcuoycuosittm
-- md5(pg_get_functiondef) = f21219150f0eb532ce5b32c9e8c6cf2b
-- NOTE: rolling back to this body restores the known RC-02 defects
-- (absolute-set WH debit, silent GREATEST clamps, oldest-row-any-status
-- targeting via nested adjust_warehouse_stock, forged request.jwt.claims).
