...
-- object: receive_dispatch_line(uuid,numeric,uuid,jsonb)
-- md5(pg_get_functiondef) = 780e34d8c4c436ea8d9d9c7df85efcbb
-- restore via: DROP+CREATE (signature changed to add p_override,p_override_reason)
