...
BEGIN
  ...
  SELECT machine_id INTO v_m1 FROM machines WHERE status='Active' ORDER BY official_name LIMIT 1;
  SELECT machine_id INTO v_m2 FROM machines WHERE status='Active' AND machine_id <> v_m1 ORDER BY official_name LIMIT 1;
  SELECT product_id INTO v_bp FROM boonz_products LIMIT 1;
  SELECT shelf_id INTO v_shelf FROM shelf_configurations WHERE machine_id = v_m1 LIMIT 1;
  ...
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 5, true, v_wh, b_stale, 'warehouse') RETURNING dispatch_id INTO d_a;
  ...
  INSERT INTO refill_dispatching (dispatch_id, machine_id, shelf_id, boonz_product_id, dispatch_date, action, quantity, include, from_warehouse_id, from_wh_inventory_id, source_origin)
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 4, true, v_wh, b_pin, 'warehouse') RETURNING dispatch_id INTO d_b;
  ...
  INSERT INTO warehouse_inventory (wh_inventory_id, boonz_product_id, warehouse_id, warehouse_stock, expiration_date, batch_id, status, snapshot_date, quarantined)
  VALUES (gen_random_uuid(), v_bp, v_wh, 30, current_date + 40, 'PRD072-C-Q', 'Active', current_date, true) RETURNING wh_inventory_id INTO b_q;
  INSERT INTO refill_dispatching (dispatch_id, machine_id, shelf_id, boonz_product_id, dispatch_date, action, quantity, include, from_warehouse_id, from_wh_inventory_id, source_origin)
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 3, true, v_wh, b_q, 'warehouse') RETURNING dispatch_id INTO d_c;
  ...
  UPDATE warehouse_inventory SET quarantined = false, warehouse_stock = 0 WHERE wh_inventory_id = b_q;
  INSERT INTO warehouse_inventory (wh_inventory_id, boonz_product_id, warehouse_id, warehouse_stock, expiration_date, batch_id, status, snapshot_date)
  ...
  INSERT INTO refill_dispatching (dispatch_id, machine_id, shelf_id, boonz_product_id, dispatch_date, action, quantity, include, from_warehouse_id, from_wh_inventory_id, source_origin)
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 2, true, v_wh, b_inact, 'warehouse') RETURNING dispatch_id INTO d_d;
  ...
  INSERT INTO refill_dispatching (dispatch_id, machine_id, shelf_id, boonz_product_id, dispatch_date, action, quantity, include, from_warehouse_id, from_wh_inventory_id, source_origin)
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 5, true, v_wh, b_part, 'warehouse') RETURNING dispatch_id INTO d_e;
  ...
  r := r || CASE WHEN res->>'status'='credited' AND (res->>'remainder')::numeric = 2 AND v_stock = 2
  ...
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 4, true, v_wh, 'warehouse') RETURNING dispatch_id INTO d_g1;
  ...
  VALUES (gen_random_uuid(), v_m1, v_shelf, v_bp, current_date, 'Refill', 4, true, true, 'dry test', 'warehouse') RETURNING dispatch_id INTO d_g2;
  BEGIN
