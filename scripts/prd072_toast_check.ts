...
const cases: [unknown, string | null, string][] = [
  [
    { status: "ok", lines_pushed: 12, rpc_version: "v7_prd071_autopair_m2m" },
    null,
    "✅ 12 lines pushed to dispatch",
  ],
  ...
  [
    {
      status: "ok",
      lines_pushed: 5,
      lines_preserved_manual_edit: 2,
      m2m_transfer_pairs: 1,
    },
    null,
    "✅ 5 lines pushed to dispatch (2 preserved, 1 M2M pair)",
  ],
  [
    { status: "error", error: "Machine not found: X" },
    null,
    "⚠️ Push failed: Machine not found: X",
  ],
  [
    { status: "conservation_violation", reason: "SUM mismatch" },
    null,
    "⛔ Push stopped: SUM mismatch",
  ],
