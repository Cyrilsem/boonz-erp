-- Rollback capture for supabase/migrations/20260925130000_loopv2_f7f8_pick_machines_v12_fixes.sql
-- Prior live pick_machines_v12 body, captured via pg_get_functiondef before the F7/F8 migration
-- ran. Rollback = re-apply this CREATE OR REPLACE.
