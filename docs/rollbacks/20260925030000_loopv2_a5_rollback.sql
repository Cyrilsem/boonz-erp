-- Rollback capture for 20260925030000_loopv2_a5_m2w_suppress_qty_zero.sql
-- Prior live body of engine_finalize_pod(p_plan_date, p_machine_ids) (engine_version
-- 'v15_1_machine_scope_precedence'), which set status='superseded' on auto-suppressed orphan
-- M2W/REMOVE rows without zeroing qty.
