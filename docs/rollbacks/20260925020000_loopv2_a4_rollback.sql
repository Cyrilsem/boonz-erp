-- Rollback capture for 20260925020000_loopv2_a4_m2m_lot_flavour_match.sql
-- Prior live bodies of push_plan_to_dispatch (v20_loopv2_a1_m2m_not_picked_up_at_push) and
-- add_m2m_transfer, both with the unfiltered shelf-only lot lookup (no boonz_product_id filter).
