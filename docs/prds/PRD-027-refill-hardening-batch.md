...
- [x] WS5: APPLIED 2026-06-12 as `phaseF_stitch_v21_ws5_real_stock` (stitch v21 emits real current/max stock from v_live_shelf_stock / v_shelf_max_stock; honest 0 where neither view has data). CS explicitly green-lit the within-24h second rewrite; Cody approved the full verbatim body at apply time; reverse-fragment md5 proof vs v20. Sequenced before the PRD-024 section-2 re-stitch so the rebuilt 06-13 plan ships with real stock fields.
