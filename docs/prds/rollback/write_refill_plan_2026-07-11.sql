-- Rollback for PRD-CLEAN-05: original write_refill_plan (preflight g7, name-keyed INSERT)
-- as of 2026-07-11, before the ID-populating g8 version.
...
-- Column rollback (data-preserving alternative: leave columns, they are nullable):
-- ALTER TABLE public.refill_plan_output
--   DROP COLUMN machine_id, DROP COLUMN shelf_id,
--   DROP COLUMN pod_product_id, DROP COLUMN boonz_product_id;
-- DROP INDEX IF EXISTS idx_rpo_plan_machine;
