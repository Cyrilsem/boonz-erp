...
export default function ProductsPage() {
  ...
  return (
    ...
    >
      ...
      {/* ========== TAB 4: Performance ==========
          PRD-087 R3 — the catalogue-style velocity ledger (same component as
          Performance → Product Performance) replaces the old blue bucket view. */}
      {activeTab === "performance" && <ProductPerformanceTab />}
