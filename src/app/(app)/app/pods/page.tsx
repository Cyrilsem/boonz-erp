...
const FALLBACK_CATEGORIES: LocationCategory[] = [
  {
    code: "in_market",
    label: "In Market",
    hint: "installed & selling",
    sort_order: 0,
    wins_over_active: false,
    collapsed_by_default: false,
    assignable: false,
  },
  {
    code: "office",
    label: "Office / Central",
    hint: "stored at the office",
    sort_order: 10,
    wins_over_active: false,
    collapsed_by_default: false,
    assignable: true,
  ...
  },
  {
    code: "lebanon",
    label: "Lebanon",
    hint: "Lebanon market — active or staged",
    sort_order: 40,
    wins_over_active: true,
    collapsed_by_default: false,
    assignable: true,
  },
  {
    code: "legacy",
    label: "Legacy (records only)",
    hint: "records only — not counted",
    sort_order: 50,
    wins_over_active: true,
    collapsed_by_default: true,
    assignable: true,
          ...
          <>
            ...
            <div style={grid2}>
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                >
                  <option value="">
                    — automatic (In Market when Active) —
                  </option>
                  {categories
