                    ...
                    <Field
                      ...
                      value={
                        <span style={{ fontWeight: 700 }}>
                          {(
                            selectedBatch.warehouse_stock ?? 0
                          ).toLocaleString()}
                      ...
                      linkedPOLine.physical_received_qty === null && (
                        ...
                        >
                          ...
                          >
                            ...
                            received on{" "}
                            {linkedPOLine.received_date?.slice(0, 10) ?? "—"}{" "}
                            (qty {linkedPOLine.received_qty ?? "—"}) but the
                            physical count has not been confirmed.
                          </div>
                          {!showConfirmReceipt ? (
                            <button
                              type="button"
                  ...
                  <>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        background:
                          saveBusy || !canEdit ? "#9ca39a" : "#24544a",
                        color: "white",
                        fontSize: 14,
                        fontWeight: 600,
                        cursor:
                          saveBusy || !canEdit ? "not-allowed" : "pointer",
                        fontFamily: font,
                      }}
                    >
